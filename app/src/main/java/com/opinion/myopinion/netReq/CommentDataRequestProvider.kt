...
class CommentDataRequestProvider(private val context: Context, private val fragment: Fragment) :
    CommentService {
    ...
    override fun sendComment(editText: EditText) {
        ...
        val referenceForCommentImage: DatabaseReference =
            databaseForCommentImage.getReference("users")
